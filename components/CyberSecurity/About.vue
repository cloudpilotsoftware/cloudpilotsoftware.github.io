      ...
      <div class="row align-items-center">
        ...
        <div class="col-lg-6">
          <div class="info">
            ...
            <p> Cybersecurity is the practice of protecting systems, networks, <br /> and programs from digital attacks.
            </p>
            <p> These cyberattacks are usually aimed at accessing, changing, <br /> or destroying sensitive information;
              extorting money from user <br /> or interrupting normal business processes. </p>
