...
import nuxt_plugin_vuescrollto_ed8a03aa from 'nuxt_plugin_vuescrollto_ed8a03aa' // Source: .\\vue-scrollto.js (mode: 'client')
...
async function createApp(ssrContext, config = {}) {
  ...
  if (process.client && typeof nuxt_plugin_vuescrollto_ed8a03aa === 'function') {
    await nuxt_plugin_vuescrollto_ed8a03aa(app.context, inject)
  }
